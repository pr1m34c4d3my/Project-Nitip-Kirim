      ...
      <div class="row text-center" id="estimasi"><table class="table table-striped table-bordered table-estimasi">
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>-</td>
                <td>995.000/<sub>kg</sub></td>
               
            </tr>
            <tr>
                <td>2</td>
                <td>-</td>
                <td>910.000/<sub>kg</sub></td>                
            </tr>
            <tr>
                <td>3</td>
                <td>-</td>
                <td>840.000/<sub>kg</sub></td>          
            </tr>
            <tr>
                <td>4</td>
                <td>-</td>
                <td>790.000/<sub>kg</sub></td>
            </tr>
            <tr>
                <td>5</td>
                <td>-</td>
                <td>740.000/<sub>kg</sub></td>
            </tr>
            <tr>
                <td>6-10</td>
                <td>-</td>
                <td>700.000/<sub>kg</sub></td>
            </tr>
            <tr>
                <td>11-20</td>
                <td>-</td>
                <td>670.000/<sub>kg</sub></td>
            </tr>
            <tr>
                <td>21-30</td>
                <td>-</td>
                <td>640.000/<sub>kg</sub></td>
            </tr>
            <tr>
                <td>&gt; 31</td>
                <td><b>WA</b></td>
