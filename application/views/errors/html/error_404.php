...
<main>
  <aside class="side-box hidden-sm"> <span class="close-side-box"><i class="ion-close"></i></span>
    <div class="side-about">
      ...
      <p>Nitipkirim.com adalah Brand dari PT. Titik Cahaya Khatulistiwa, yaitu jasa Forwadning Ekspor, Impor keseluruhan Negara. Kami melayani pengiriman tanpa batas sesuai dengan prosedur.</p>
    ...
    <div class="pdf-catalog">
      ...
      <p>Download estimasi sesuai catalog regional.</p>
  ...
  <header class="full-header">
    <nav class="navbar navbar-default">
      <div class="top-bar">
        <div class="container">
          <div class="row">
            <div class="col-md-6 col-sm-6 hidden-xs"> Ada 547,684 paket yang kami kirim <span class="numbers">8.903</span> Selesai</div>
            <!-- end col-6 -->
            <div class="col-md-3 col-sm-2 col-xs-4">
              <div class="language dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="images/flag-400.png" alt="Image">Bahasa</a>
            ...
            <span class="weather"><i class="ion-ios-partlysunny"></i></span> 
            <a href="https://api.whatsapp.com/send?phone=6281389369998&text=Halo%21%20saya%20ingin%20bertanya."> <span class="phone"><i class="ion-ios-telephone"></i> +62 813 8936 9998 </span></a> </div>
            <!-- end col-3 --> 
          </div>
          <!-- end row --> 
        </div>
      ...
      <div class="container">
        <div class="navbar-header">
          <div class="row">
            <div class="col-md-3 col-sm-4 col-xs-12">
              ...
              <a class="navbar-brand" href="Home"><img src="images/logo-baru.png" alt="Logo Nitip Kirim"></a> </div>
            <!-- end col-5 -->
              <div class="padding">
                <div class="col-md-3 col-sm-4 hidden-xs"> <i class="icon-global"></i>
                  <h6>Jam Kerja<br>
                    <span>Senin - Jumat 07:00 - 18:00 </span></h6>
                </div>
                <!-- end col-2 -->
                ...
                <div class="col-md-3 hidden-sm hidden-xs"> <i class="icon-chat"></i>
                  <h6>Layanan Admin<br>
                    <a href="https://api.whatsapp.com/send?phone=6281389369998&text=Halo%21%20saya%20ingin%20bertanya."><span>081389369998</span></a></h6>
                </div>
                <!-- end col-2 --> 
              </div>
          </div>
        ...
        <div class="collapse navbar-collapse cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav main-menu">
            <li><a href="Home" class="transition">BERANDA</a></li>
            <li><a href="Estimasi" class="transition">ESTIMASI</a></li>
            <li><a href="Tentang" class="transition">TENTANG KAMI</a></li>
            <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#">LAYANAN</a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="Nitipexport" class="transition">NITIP EXPORT</a></li>
                <li><a href="Nitipimport" class="transition">NITIP IMPORT</a></li>
                <li><a href="Nitipnusantara" class="transition">NITIP NUSANTARA</a></li>
              </ul>
            </li>
            <li><a href="News" class="transition">ARTIKEL</a></li>
            <li><a href="Contact" class="transition">HUBUNGI KAMI</a></li>
          </ul>
...
<div class="main">
  ...
  <g id="train">
    ...
    <g id="car-layers">
      ...
      <g id="Text">
		...
		<text transform="translate(500 220.025)" class="st8 st10" font-size="21">
  ...
  <footer class="dark-footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-sm-6">
            <h4 class="title"><span>01</span>Tentang Kami</h4>
            <p>
              Nitipkirim.com adalah Brand dari PT. Titik Cahaya Khatulistiwa, 
              yaitu jasa Forwadning Ekspor, Impor keseluruhan Negara. 
              Kami melayani pengiriman tanpa batas sesuai dengan prosedur.
            </p>
          ...
          <div class="col-md-2 col-sm-3 col-xs-6">
            <h4 class="title"><span>02</span>Layanan Kami</h4>
            <ul class="footer-menu">
              <li><a href="Nitipexport">Nitip Export</a></li>
              <li><a href="Nitipimport">Nitip Import</a></li>
              <li><a href="Nitipnusantara">Nitip Nusantara</a></li>
            </ul>
          </div>
          <!-- end col-2 -->
          <div class="col-md-2 col-sm-3 col-xs-6">
            <h4 class="title"><span>03</span>Nitip Kirim</h4>
            <ul class="footer-menu">
              <li><a href="Tentang">Tentang Kami</a></li>
              <li><a href="News">Artikel</a></li>
              <li><a href="belumada">Layanan Kami</a></li>
              <li><a href="belumada">Site Maps</a></li>
            </ul>
          </div>
          <!-- end col-2 -->
          <div class="col-md-4">
            <div class="newsletter">
              <h4 class="title"><span>04</span>Info Layanan dan Diskon</h4>
              <p>Jika anda ingin dapat info menarik, anda dapat mengikuti kami.</p>
              <form>
                <input type="text" placeholder="Type your e-mail">
                <button type="submit">Gabung</button>
              </form>
              <small>Kami Janji, Ga akan rese!</small> </div>
            <!-- end newsletter --> 
          </div>
          <!-- end col-2 --> 
        </div>
    ...
    <div class="sub-footer">
      <div class="container"> <span class="copyright">Copyright © 2022 , Nitip Kirim </span></div>
      <!-- end container --> 
    </div>
    <!-- end sub-footer --> 
  </footer>
